...
- [ ] **1.10 SEO expansion.** (Partial Aug 2026: per-trait pages for all 11 pickable traits incl. Sable, Highway, ChoCho. Remaining: per-pairing landing pages for the top searched crosses.) Per-trait calculator pages for every newly exposed trait, plus per-pairing landing pages for the top searched crosses ("Lilly White x Lilly White," "Cappuccino x Sable," "Axanthic x het Axanthic") with pre-filled parents and explainer copy. These match documented search behavior and the questions asked constantly in forums.
