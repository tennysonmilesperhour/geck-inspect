...
export default function AccountDeletionCard({ user }) {
  ...
  return <Card className="border-red-900 bg-slate-900">
    ...
    <CardContent className="space-y-4">
      ...
      <p className="text-sm text-slate-400">For deletion questions or help accessing your account, email <a href={SUPPORT_EMAIL_URL} className="text-emerald-300 underline break-all">{SUPPORT_EMAIL}</a>.</p>
