...
export default function EmailCaptureCard({ source = 'homepage' }) {
  ...
  return (
    <section className="relative z-10 max-w-4xl mx-auto px-6 pb-24">
      <div className="rounded-2xl border border-emerald-500/30 bg-gradient-to-br from-emerald-950/50 via-slate-900/70 to-slate-900/40 backdrop-blur p-6 md:p-10 shadow-2xl shadow-emerald-500/10">
        <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-8 items-center">
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
              <div className="flex items-start gap-3 rounded-lg border border-emerald-500/20 bg-emerald-950/30 px-4 py-3">
            ...
            {submitted ? (
              <div className="rounded-lg border border-emerald-500/40 bg-emerald-500/10 px-4 py-3 inline-flex items-center gap-3 text-emerald-200">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-2">
                <input
                  ...
                  className="flex-1 rounded-lg bg-slate-900/80 border border-slate-700 px-4 py-3 text-sm text-white placeholder:text-slate-500 focus:border-emerald-500 focus:outline-none"
                  maxLength={254}
                  autoComplete="email"
                />
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="inline-flex items-center justify-center gap-2 rounded-lg bg-emerald-600 hover:bg-emerald-500 disabled:bg-emerald-700/50 px-5 py-3 text-sm font-semibold text-white transition-colors"
                >
                  {submitting ? (
                    <>
