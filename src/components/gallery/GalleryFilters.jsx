                ...
                <div className="space-y-2">
                    ...
                    <Select value={filters.primary_morph} onValueChange={value => handleFilterChange('primary_morph', value)}>
                        ...
                        <SelectContent className="bg-emerald-900/95 border-emerald-600 text-emerald-100 z-[99999]">
                            <SelectItem value="all" className="text-emerald-100 focus:bg-emerald-600 focus:text-white hover:bg-emerald-700">All Morphs</SelectItem>
                            {options.morphs.map(morph => <SelectItem key={morph} value={morph} className="text-emerald-100 focus:bg-emerald-600 focus:text-white hover:bg-emerald-700">{formatLabel(morph)}</SelectItem>)}
                        </SelectContent>
                    </Select>
                </div>
                <div className="space-y-2">
                    ...
                    <Select value={filters.base_color} onValueChange={value => handleFilterChange('base_color', value)}>
                        <SelectTrigger className="h-10 bg-emerald-900/80 border-emerald-600 text-emerald-100 hover:bg-emerald-800 focus:ring-emerald-500"><SelectValue /></SelectTrigger>
                        <SelectContent className="bg-emerald-900/95 border-emerald-600 text-emerald-100 z-[99999]">
                            <SelectItem value="all" className="text-emerald-100 focus:bg-emerald-600 focus:text-white hover:bg-emerald-700">All Colors</SelectItem>
                            {options.colors.map(color => <SelectItem key={color} value={color} className="text-emerald-100 focus:bg-emerald-600 focus:text-white hover:bg-emerald-700">{formatLabel(color)}</SelectItem>)}
                        </SelectContent>
                    </Select>
                </div>
                <div className="space-y-2">
                    ...
                    <Select value={filters.sort} onValueChange={value => handleFilterChange('sort', value)}>
                        <SelectTrigger className="h-10 bg-emerald-900/80 border-emerald-600 text-emerald-100 hover:bg-emerald-800 focus:ring-emerald-500"><SelectValue /></SelectTrigger>
                        <SelectContent className="bg-emerald-900/95 border-emerald-600 text-emerald-100 z-[99999]">
                            <SelectItem value="-created_date" className="text-emerald-100 focus:bg-emerald-600 focus:text-white hover:bg-emerald-700">Newest</SelectItem>
                            <SelectItem value="created_date" className="text-emerald-100 focus:bg-emerald-600 focus:text-white hover:bg-emerald-700">Oldest</SelectItem>
                        </SelectContent>
                    </Select>
                </div>
                <div className="space-y-2">
                    <Popover>
                        <PopoverTrigger asChild>
                            <Button variant="outline" className="w-full h-10 bg-emerald-900/80 border-emerald-600 text-emerald-100 hover:bg-emerald-800">
                        ...
                        <PopoverContent className="w-64 p-0 bg-emerald-900/95 border-emerald-600 text-emerald-100">
