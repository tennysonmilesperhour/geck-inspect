...
export const BLOG_POSTS = [
  ...
  },
  {
    ...
    description: "Pairing two Cappuccino crested geckos looks like a guaranteed win on paper. One in four hatchlings will be a Frappuccino ,  and that may be costing you more than you think.",
    ...
    tldr: [
      "Cappuccino is incomplete dominant ,  pairing two visuals produces 25% Frappuccino (super form), 50% Cappuccino, 25% non-carrier.",
      "Some breeders report reduced vigor or developmental issues in Frappuccino hatchlings; viability concerns are real but not yet fully documented.",
      "The safest and most productive pairing is Cappuccino × non-carrier ,  50% Cappuccino offspring, zero Frappuccino risk.",
    ...
    body: [
      ...
      },
      {
        ...
        items: [
          ...
          "**Frappuccino** (two copies): a more extreme expression, paler body, amplified saddle",
        ],
      },
      {
        type: "p",
      ...
      {
        type: "p",
        text: "But here's what the math doesn't tell you: one in four of your hatchlings is a Frappuccino, and the community data on Frappuccino viability is not clean. The genetics-sections.jsx section on lethal alleles and super form viability says it plainly: \"some breeders report reduced clutch sizes, higher egg-failure rates, or subtle developmental issues when producing Frappuccinos from Cappuccino × Cappuccino pairings.\" It also recommends conservative breeding: \"Cappuccino × normal unless you're specifically investigating Frappuccino outcomes and prepared to document them.\"",
      },
      {
        type: "p",
      ...
      {
        type: "p",
        text: "**What's consistent with the genetics:** Sub-lethal homozygous effects are common in incomplete-dominant morphs. The genetics-sections.jsx explicitly notes that the Frappuccino super form has \"ongoing debate about sublethal effects.\" The corpus does not confirm a clean lethal like Lilly White, but it does acknowledge the concern is real.",
      },
      {
        type: "p",
        text: "**What's NOT confirmed:** A precise viability percentage, a specific developmental mechanism, or whether the \"runts\" are consistently Frappuccinos or sometimes one-copy Cappuccinos from stressed clutches.",
      },
      {
        type: "p",
      ...
      {
        type: "p",
        text: "Part of this is simple math appeal. Two Cappuccinos = more Cappuccinos + a shot at the premium super form. Part of it is the absence of a confirmed lethal (unlike Lilly White, where the LW × LW prohibition is airtight and well-known). And part of it is that the Frappuccino is genuinely striking ,  paler, more neutral body color and amplified saddle, per the morph guide ,  and commands a premium when it's healthy.",
      },
      {
        type: "p",
      ...
      {
        type: "p",
        text: "The problem is that \"see what happens\" is not a breeding strategy. It's an experiment. And when you're running an experiment on animals, you have an obligation to document the outcomes ,  hatch rates, hatchling weights at 30 days, growth curves through 90 days ,  and share them. The Frappuccino's viability profile will only get resolved when breeders actually track and publish this data rather than quietly selling the small ones as \"Cappuccinos\" and moving on.",
      },
      {
        type: "callout",
        tone: "info",
      ...
      },
      {
        ...
        items: [
          ...
          "Zero Frappuccinos ,  and zero associated viability risk",
      ...
      {
        type: "p",
        text: "For a breeding program with a two- to three-year horizon, running Cappuccino × quality non-carrier is how you build a stable line. The 25% Frappuccino gamble from Cap × Cap might produce one premium animal per clutch ,  but if that animal comes in undersized and takes six months to catch up, the price premium evaporates. And if it doesn't catch up at all, you've got an animal that's difficult to sell honestly and potentially unhealthy.",
      },
      {
        type: "p",
      ...
      {
        type: "p",
        text: "If you're a serious breeder and you want to characterize Frappuccino viability, run the pairing, track every egg from lay date through 90-day weight, and publish the data. That's genuinely valuable for the community. The genetics-sections.jsx says it directly: \"if you do breed for Frappuccino, be transparent about clutch outcomes ,  the community needs data to establish whether homozygous viability is a real concern.\"",
      },
      {
        type: "p",
      ...
      {
        type: "p",
        text: "The videos calling Frappuccinos a \"scam\" are getting traction because real buyers are getting real surprises. The genetics aren't a scam; the lack of disclosure is.",
      },
      {
        type: "callout",
        tone: "info",
        title: "How to tell if your hatchling might be a Frappuccino",
      },
      {
        type: "p",
        text: "You can't be certain without lineage, but there are visual signals to watch. Per the morph guide's Frappuccino entry, the super form shows \"amplified saddle with very clean edges\" and \"paler, more neutral body color than single-copy cappuccino.\" In hatchlings, this often translates to a noticeably lighter, more washed-out appearance compared to siblings.",
      },
      {
        type: "p",
      ...
      },
      {
        ...
        items: [
          ...
          "Note which animals have the most washed-out, pale body tone ,  those are your Frappuccino candidates.",
          "Weigh all hatchlings at hatch and at 30 days. A Frappuccino that's growing normally is almost certainly fine. A Frappuccino that's 20% lighter than siblings at 30 days is a concern.",
      ...
      {
        type: "p",
        text: "**If you're committed to producing Frappuccinos:** Run the pairing, document every hatch outcome in detail, hold hatchlings to 60 days, and be transparent with buyers about what a Frappuccino is. Set a weight threshold (I'd suggest 5 grams at 60 days as a minimum before sale) and don't sell animals that don't clear it.",
      },
      {
        type: "p",
        text: "**If you're buying a \"Cappuccino\" hatchling:** Ask for lineage. Ask what the pairing was. A hatchling from Cap × Cap is not the same risk profile as one from Cap × non-carrier, and the price should reflect that. A visual Cappuccino with no lineage documentation might be a Frappuccino ,  you won't know for months.",
      },
      {
        type: "p",
        text: "**If you're evaluating animals you already produced:** Don't sell small hatchlings from Cap × Cap pairings as standard Cappuccinos. They may be Frappuccinos with sublethal developmental load. Hold them, document them, and price them honestly.",
      },
      {
        type: "p",
        text: "The breeder at the expo who spent $1,400 on that female did nothing wrong ,  he just made a pairing decision without a plan for what to do with 25% of the outcome. His three dead eggs and two small hatchlings aren't a genetics failure. They're a documentation gap. He doesn't know if those slow animals were Frappuccinos, whether the viability issue is consistent in his line, or whether his male Cappuccino is producing the same problem with other females. He's flying blind on the most important question his project raises.",
      },
      {
        type: "p",
    ...
    faq: [
      {
        question: "Is it safe to breed two Cappuccino crested geckos together?",
        answer: "It's not confirmed-unsafe the way Lilly White × Lilly White is ,  Frappuccinos survive. But multiple breeders report higher egg-failure rates and slow-growing hatchlings from Cap × Cap pairings. The conservative default is Cappuccino × non-carrier: you get 50% Cappuccino offspring with no Frappuccino viability risk at all.",
      },
      {
        question: "What is a Frappuccino crested gecko?",
        answer: "Frappuccino is the super (homozygous) form of the Cappuccino incomplete-dominant morph. Two copies of the Cappuccino gene produce an animal with an amplified saddle, paler neutral body color, and very clean pattern edges. They're rarer and command a premium when healthy, but some lines show developmental concerns.",
      },
      {
        question: "How do I know if my hatchling is a Frappuccino or a regular Cappuccino?",
        answer: "Frappuccinos tend to look noticeably paler and more washed-out than single-copy Cappuccino siblings at hatch. Amplified saddle with very clean edges is the key visual signal. Lineage is the only reliable confirmation ,  if both parents are visual Cappuccinos, 25% of the clutch is expected to be Frappuccino.",
      },
      {
        question: "Why are some Cappuccino hatchlings staying small?",
        answer: "Slow growth in hatchlings from Cap × Cap pairings is consistent with sublethal effects in the homozygous Frappuccino form. Not all Frappuccinos show this, but the pattern appears often enough in community reports to be a real concern. Track weights at 30 and 60 days ,  an animal that isn't gaining normally by 60 days needs assessment before sale.",
      },
      {
        question: "What is the best pairing for a Cappuccino crested gecko project?",
        answer: "Cappuccino × high-quality non-carrier. This produces 50% visual Cappuccinos in every clutch with no Frappuccino viability risk. Use the non-carrier to bring in strong background genetics ,  harlequin, red base, or extreme pattern will push your Cappuccino line's visual quality forward while keeping hatchling health predictable.",
      },
      {
        question: "Do Cappuccino crested geckos have health problems?",
        answer: "Single-copy visual Cappuccinos have no documented health concerns. The Frappuccino (homozygous super form) is where some breeders report issues ,  reduced hatch rates and slower early growth. These effects aren't universal and haven't been formally studied, but they're consistent enough in community reports to justify caution with Cap × Cap pairings.",
      },
      {
        question: "Is the Cappuccino morph recessive or dominant?",
        answer: "Neither. Cappuccino is incomplete dominant ,  one copy produces the visible Cappuccino form, and two copies produce the Frappuccino (super form). This is the most common inheritance pattern among proven crested gecko morphs, shared with Lilly White, Soft Scale, and White Wall.",
      },
      {
        question: "What percentage of offspring from Cap × Cap are Frappuccinos?",
        answer: "About 25% across many clutches. The expected ratio from pairing two visual Cappuccinos is: 25% non-carrier, 50% visual Cappuccino, 25% Frappuccino. Individual clutches will vary ,  you can get three Frappuccinos in one clutch and none in the next. The average holds across a large enough sample size.",
      },
    ],
    internalLinks: [
      {
      ...
      {
        href: "/MorphGuide/frappuccino",
        label: "Frappuccino (super Cappuccino) profile",
      },
      {
        href: "/GeneticsGuide",
  ...
  {
    slug: "cappuccino-breeding-incomplete-dominance",
    title: "Why Pairing Two Cappuccinos Won't Give You More Cappuccinos",
    description: "Breeding two Cappuccino crested geckos produces Frappuccinos, not more Cappuccinos. Learn how incomplete dominance changes the math and why Cap x Cap is a risky pairing.",
    ...
    heroEyebrow: "Genetics Deep Dive",
    tldr: [
      "Cappuccino is incomplete dominant, not recessive. One copy is visual, two copies produce Frappuccino (Super Cappuccino).",
      "Pairing Cap x Cap gives you 25% Frappuccino, 50% Cappuccino, and 25% visually normal offspring, not 100% Cappuccinos.",
      "Frappuccino viability is genuinely debated. Some breeders report reduced clutch sizes and developmental issues from Cap x Cap pairings.",
      "The safest and most productive Cappuccino pairing is Cappuccino x non-carrier, which yields 50% Cappuccino offspring with zero lethal-super risk.",
      "Background genetics matter as much as the named morph. Buy from a line whose animals look the way you want yours to look.",
    ],
    body: [
      {
        type: "p",
        text: "A breeder at a 2024 reptile expo told me she paid $900 for a pair of visual Cappuccinos, bred them immediately, and was confused when the hatchlings came out looking nothing like she expected. One animal was dramatically darker and stranger-looking than either parent. Two others looked completely normal. She thought she'd received bad animals. She hadn't. She just didn't understand what Cappuccino actually does when you put two of them together.",
      },
      {
        type: "p",
        text: "This post is about that math, why it surprises people, and what to do instead.",
      },
      {
        type: "callout",
        tone: "info",
        title: "What \"incomplete dominant\" actually means",
      },
      {
        type: "p",
        text: "Cappuccino is a proven incomplete-dominant morph. That phrase gets used a lot in the hobby, but it's worth unpacking what it actually means before we get to breeding ratios.",
      },
      {
        type: "p",
        text: "In a recessive morph, you need two copies of the gene for the animal to display the trait. One copy is invisible. Axanthic works this way: a single het axanthic looks completely normal. You'd never know it was carrying anything unless you had the lineage paperwork.",
      },
      {
        type: "p",
        text: "Incomplete dominance is different. With an incomplete-dominant gene, **one copy is already visible.** The animal you see, the one with the warm chocolate tones and the connected dorsal saddle pattern, is heterozygous. It carries one copy of the Cappuccino allele and one copy of the normal allele.",
      },
      {
        type: "p",
        text: "Two copies produce something different again. Not the same trait amplified, but a distinct phenotype with a distinct name: Frappuccino. More extreme color, more extreme pattern, and an ongoing debate about whether these animals are fully healthy.",
      },
      {
        type: "p",
        text: "So when you put two visual Cappuccinos together, you are not breeding Cappuccino to Cappuccino in the way a beginner might imagine it, like mixing two buckets of the same paint. You are breeding heterozygous to heterozygous, and that has specific, predictable consequences.",
      },
      {
        type: "callout",
        tone: "info",
        title: "The Punnett square you need to see",
      },
      {
        type: "p",
        text: "Call the Cappuccino allele \"C\" and the normal allele \"n.\" A visual Cappuccino is Cn. When you pair Cn x Cn, here is what a Punnett square tells you:",
      },
      {
        type: "ul",
        items: [
          "25% CC (Frappuccino, the super form)",
          "50% Cn (visual Cappuccino, what you started with)",
          "25% nn (visually normal, no Cappuccino at all)",
        ],
      },
      {
        type: "p",
        text: "Three outcomes. One of them is what you wanted. One of them looks like nothing happened. And one of them is something you may not have been ready for.",
      },
      {
        type: "p",
        text: "If you are hoping to fill a rack with Cappuccinos, the honest ceiling from a Cap x Cap pairing is 50%. The other half of your clutch is either supers or normals. Across a typical crested gecko clutch of two eggs, the numbers are small enough that you can easily get a full clutch of normals or a full clutch of supers entirely by chance. The ratios only hold over many clutches.",
      },
      {
        type: "p",
        text: "Compare that to the alternative: pair your visual Cappuccino to a non-carrier. Now the math is 50% Cappuccino, 50% normal. No Frappuccinos at all. More Cappuccinos per clutch on average, and none of the uncertainty around super-form viability.",
      },
      {
        type: "callout",
        tone: "info",
        title: "The Frappuccino question",
      },
      {
        type: "p",
        text: "Here is where the post gets genuinely complicated, because the hobby does not have a clean answer yet.",
      },
      {
        type: "p",
        text: "Frappuccinos exist. They are being bred and sold. That part is not in dispute. What is debated is whether homozygous Cappuccinos carry health or viability concerns similar to the lethal Super Lilly White.",
      },
      {
        type: "p",
        text: "The Geck Inspect genetics corpus is direct about this: some breeders report reduced clutch sizes, higher egg-failure rates, or subtle developmental issues from Cappuccino x Cappuccino pairings. The super form has been described as having \"some reported viability concerns.\" This is not the same as \"confirmed lethal\" the way Super Lilly White is. Frappuccinos hatch. They survive. But the community lacks the kind of multi-breeder, multi-clutch documentation that would settle the question cleanly.",
      },
      {
        type: "p",
        text: "My read: the uncertainty itself is the reason to be cautious. Lilly White was not confirmed lethal until enough breeders had bred it to enough partners and tracked enough egg failures to see the pattern. Cappuccino may be on the same trajectory, or it may turn out to be fine. Until that documentation exists, breeding Cap x Cap to produce Frappuccinos is a choice that deserves more transparency than it typically gets.",
      },
      {
        type: "p",
        text: "If you do breed two Cappuccinos together, write down every outcome. Eggs that failed. Animals with unusual presentations. Clutch sizes that seemed low. The community needs that data. Individual breeders sitting on it quietly do no one any favors.",
      },
      {
        type: "callout",
        tone: "info",
        title: "Why the \"more Cappuccinos\" assumption happens",
      },
      {
        type: "p",
        text: "It is worth being specific about where the confusion comes from, because it is not random. Most people who come into crested gecko breeding after keeping common pets have an intuitive model of genetics that goes something like: if both parents have it, the babies will have it. That model works reasonably well for dominant traits (though it fails even there in some cases). It completely breaks down for incomplete dominants.",
      },
      {
        type: "p",
        text: "When someone looks at a visual Cappuccino and thinks \"this animal is Cappuccino,\" they are thinking about it the way you think about a recessive visual: both alleles are the morph. That is simply not how it works. A visual Cappuccino is a single-copy animal. One allele is Cappuccino. The other is normal. It looks Cappuccino because one copy is enough to change the phenotype, but genetically it is exactly as \"normal\" as it is \"Cappuccino.\"",
      },
      {
        type: "p",
        text: "This is the single most important thing to understand about incomplete dominance, and it is the thing that most beginner-level guides skip over because it requires actually explaining what an allele is.",
      },
      {
        type: "callout",
        tone: "info",
      ...
      {
        type: "p",
        text: "If your goal is to produce more visual Cappuccinos, the answer is simple: pair your visual Cappuccino to a non-carrier. You will get 50% Cappuccino and 50% normal offspring. The normal offspring have no breeding value for Cappuccino unless you test-breed them to confirm they are not carrying anything unexpected (they shouldn't be, but documentation is always worth having).",
      },
      {
        type: "p",
        text: "If your goal is to produce Frappuccinos specifically, pair your best-quality Cappuccino to another Cappuccino and document every outcome. Accept that 25% of your offspring will be normal, 50% will be Cappuccino, and 25% will be Frappuccino. Accept that the Frappuccino outcome carries unresolved questions about viability. Price your Frappuccinos accordingly and be honest with buyers about the current state of community knowledge.",
      },
      {
        type: "p",
        text: "If your goal is to stack Cappuccino with another morph, say Lilly White or Axanthic, the math compounds. Cappuccino x Lilly White is a common and productive combination pairing, and neither of those morphs is the same as Cappuccino x Cappuccino. Use the Geck Inspect Genetic Calculator to model multi-morph pairings before committing animals to a season.",
      },
      {
        type: "callout",
        tone: "info",
        title: "The background genetics problem",
      },
      {
        type: "p",
        text: "One more thing that gets underweighted in most Cappuccino discussions: the named morph is only part of what makes a Cappuccino animal look the way it does.",
      },
      {
        type: "p",
        text: "Cappuccino produces a characteristic saddle and warm brown tones, yes. But the specific quality of that saddle, how cleanly it is defined, how warm the body color reads, how the trait interacts with any harlequin or pinstripe pattern underneath it, all of that is shaped by the background polygenic genetics of the animal. Two visual Cappuccinos from different breeders can look strikingly different from each other, not because one of them has \"better\" Cappuccino genetics in a Mendelian sense, but because the polygenic layers underneath the morph vary.",
      },
      {
        type: "p",
        text: "This is why it matters which line you buy from. The Cappuccino allele itself is the same allele wherever you find it. What you are really paying for when you buy from a high-reputation Cappuccino breeder is the background genetics they have spent years building around it. Buy cheap Cappuccinos from a line you have not researched and you may get animals that display the morph in a way that disappoints you, regardless of the inheritance math being correct.",
      },
      {
        type: "callout",
        tone: "info",
        title: "My actual opinion on Cap x Cap pairings",
      },
      {
        type: "p",
        text: "I think Cappuccino x Cappuccino pairings are reasonable for experienced breeders who are specifically investigating Frappuccino production and have committed to documenting outcomes. I do not think they are a good choice for anyone who just bought two Cappuccinos because they thought more Cappuccinos would come out the other side.",
      },
      {
        type: "p",
        text: "The economics alone should give you pause. A Cap x Cap clutch has a 25% chance of producing an animal (the Frappuccino) whose long-term health may be compromised and whose market is, frankly, thin. A 25% chance of producing an animal with no Cappuccino genetics at all. And a 50% chance of producing what you already have. You are spinning a four-sided die for an outcome you could have gotten guaranteed from a different pairing strategy.",
      },
      {
        type: "p",
        text: "Pair Cappuccino to a normal. Produce 50% Cappuccino offspring. Sell them into a market that reliably values them at $400 to $1,200 depending on background traits. Then use the offspring from that pairing to build toward your larger project goals. That is how most of the productive Cappuccino lines in the hobby have actually been built.",
      },
      {
        type: "callout",
        tone: "info",
        title: "Before you buy your next Cappuccino pair",
      },
      {
        type: "p",
        text: "The breeder at the expo found her way to the right answer eventually. The Frappuccino she hatched turned out to be healthy, last she told me. But she spent a season confused about outcomes that were entirely predictable if she had understood the genetics going in.",
      },
      {
        type: "p",
        text: "Run the numbers before you pair. The Cappuccino morph is genuinely exciting, one of the more visually striking incomplete dominants in the species. But it follows rules, and the rules are clear. Two heterozygous animals do not produce two heterozygous offspring. They produce a spread. Understanding that spread is the difference between a season that goes as expected and a season that leaves you staring at a hatchling and wondering what happened.",
      },
    ],
    faq: [
      {
        question: "What happens when you breed two Cappuccino crested geckos together?",
        answer: "You get three possible outcomes: 25% Frappuccino (super Cappuccino, two copies), 50% visual Cappuccino (one copy, same as the parents), and 25% visually normal offspring with no Cappuccino gene. You will not get 100% Cappuccinos from this pairing.",
      },
      {
        question: "Is Cappuccino recessive or dominant in crested geckos?",
        answer: "Cappuccino is incomplete dominant. One copy produces the visual Cappuccino morph. Two copies produce Frappuccino (Super Cappuccino). This means a visual Cappuccino is always heterozygous, carrying one Cappuccino allele and one normal allele.",
      },
      {
        question: "What is a Frappuccino crested gecko?",
        answer: "Frappuccino is the homozygous (super) form of the Cappuccino morph. It is produced when two visual Cappuccinos are bred together. Frappuccinos show more extreme dark coloration and dorsal pattern than single-copy Cappuccinos. Some breeders report viability concerns with this pairing, though the issue is not fully settled.",
      },
      {
        question: "What is the safest way to produce Cappuccino offspring?",
        answer: "Pair a visual Cappuccino to a non-carrier (a gecko with no Cappuccino gene). This produces approximately 50% visual Cappuccino and 50% normal offspring, with no risk of producing a Frappuccino super form.",
      },
      {
        question: "Can you tell if a gecko is het for Cappuccino just by looking at it?",
        answer: "No. Cappuccino is incomplete dominant, not recessive, so there is no 'het' in the same sense. A visual Cappuccino is already the single-copy form. A non-carrier looks completely normal. There is no visual test for carrier status; you need documented lineage.",
      },
      {
        question: "Are Frappuccino crested geckos healthy?",
        answer: "Frappuccinos exist and many are reported healthy. However, some breeders document reduced clutch sizes and developmental concerns from Cappuccino x Cappuccino pairings. The community has not settled this with controlled multi-breeder data yet. Treat the super form as higher risk until more documentation exists.",
      },
      {
        question: "What is the difference between Cappuccino and Frappuccino?",
        answer: "Cappuccino is the single-copy (heterozygous) form: warm brown tones and a connected dorsal saddle pattern. Frappuccino is the two-copy (homozygous) form: more extreme color and pattern expression. They are the same gene at different copy numbers.",
      },
      {
        question: "Does incomplete dominance work the same way for Lilly White and Cappuccino?",
        answer: "The inheritance math is the same: one copy visible, two copies produce a super form. The key difference is outcome. Super Lilly White is confirmed embryonic-lethal and no eggs hatch. Frappuccino (Super Cappuccino) can survive but has debated viability concerns. Both supers should be approached with caution.",
      },
    ],
    internalLinks: [
      {
      ...
      {
        href: "/GeneticsGuide",
        label: "Full crested gecko genetics guide",
      },
      {
        href: "/GeneticCalculatorTool",
        label: "Genetic Calculator: model your Cappuccino pairings",
      ...
      {
        href: "/MorphGuide/lilly-white",
        label: "Lilly White morph profile (lethal super comparison)",
      },
    ],
    externalCitations: [
      {
      ...
      {
        url: "https://www.youtube.com/watch?v=3xRF-wumo_E",
        label: "Why So Much Hate for Cappuccino Geckos? The Truth No One Wants to Say... (YouTube)",
      },
    ],
  }
];
