...
The thesis compressed into a single sentence:

> **"The only platform built specifically for crested geckos, by someone who actually breeds them."**

Every section of the page either reinforces this thesis or kills an objection to acting on it. If a section does neither, it does not belong.

## 2. The problem we're solving

A visitor who lands on `geckinspect.com` is almost always in one of these states:
...
### 4.1 Specificity beats breadth

Do not dilute the message by mentioning other reptile species, other pet categories, or "expanding to more species soon." That signals either scope creep or a lack of commitment to cresties. The generalist platforms already exist; Geck Inspect's value is being the opposite of them.
...
The research is unambiguous: for UI-heavy SaaS, animated product visuals outperform screenshots, which outperform illustrations, which outperform text descriptions. The hero visual is a looping product video. The feature sections each have a real product visual. No abstract 3D shapes. No stock illustrations of geckos.

### 4.4 Honesty outperforms hype

The comparison table includes honest wins and losses vs. competitors. The pricing is on the page. The free tier is genuinely free, not a trap. The "data export" promise is load-bearing and must be real. Dishonesty on a landing page is detectable and it kills trust permanently.

### 4.5 Dark mode signals premium

The competitive set is mostly white-background, clinical, utilitarian. A dark, confident, modern aesthetic with rich crested-gecko photography reads as premium and distinct within the category. This is a positioning choice, not just a visual one.

## 5. Copy principles

### 5.1 Headline must pass the 5-second test

A cold visitor should be able to say back to you "it's a [what] for [who] that helps them [why]" after five seconds on the page. Current working headline: **"The only platform built for crested geckos."** Subhead does the benefit work. Test alternatives but measure against this bar.
...
"Trusted by breeders" is dead copy. "88 keepers tracking 250 geckos" is alive. "Fast" is dead. "Add your first gecko in 30 seconds" is alive. Default to specific, falsifiable claims.
...
### 6.1 One primary CTA, repeated

There is exactly one thing we want a visitor to do: start a free account. That CTA appears in the nav, in the hero, after every major section, and in the final CTA block. Other actions (pricing, morph guide, log in) exist in the nav but are visually subordinate. No "Watch demo" vs. "Get a quote" vs. "Contact sales" branching. One path.

### 6.2 The 5-second test is the north star

Nothing in the hero section matters more than passing the 5-second test. If any design decision reduces clarity in exchange for cleverness, revert it.

### 6.3 Mobile is the starting point, not an adaptation

62–83% of visitors arrive on mobile. The page is designed mobile-first. Tap targets ≥48×48px. Thumb-zone CTAs. Vertical-first media. Desktop is the scale-up, not the other way around.
...
A testimonial mentioning "migrated from spreadsheets in an hour" belongs near the setup-time objection. A testimonial about genetics accuracy belongs near the calculator feature. Place each piece of proof where it answers the doubt a visitor is having *at that scroll position*.

## 7. What we are deliberately not doing

These are explicit non-choices to prevent scope creep and off-thesis decisions later.

- **Not building a marketplace.** MorphMarket exists. Geck Inspect is a platform for keepers and breeders, not a buy-sell site. Listings and market analytics support breeders' decisions; they do not make Geck Inspect a storefront.
- **Not supporting other species on the landing page.** Even if the app later expands, the landing page leads with cresties only. A multi-species page would undercut the entire positioning.
- **Not gating the free tier behind a trial.** The free tier is free forever up to a gecko count. A time-limited trial would poison the trust-building the rest of the page is doing.
- **Not using stock photography.** Not a single stock image of a gecko. If we don't have a real photo for something, we get one.
- **Not using testimonials without names and photos.** Anonymous testimonials read as fake and tank trust. If we can't get a name and a face, the testimonial doesn't ship.
- **Not putting a chatbot on the marketing page.** Chatbots can help in some SaaS categories, but for a niche hobbyist/breeder audience, a chatbot reads as corporate and off-brand. If a visitor has questions, the FAQ and the founder's email are enough.
- **Not doing fake urgency or scarcity.** No "3 spots left," no fake countdown timers. The audience will see through it and it kills trust permanently.
...
If this document and a specific tactical recommendation conflict, prefer the principle. Tactics get outdated. Principles don't.

- Clarity beats cleverness.
- Specificity beats breadth.
- Honesty beats hype.
- Speed beats polish.
- One audience, deeply served, beats many audiences, shallowly served.
- Show the product. Don't describe it.
- Every word earns its place. Every section earns its scroll.
