...
function buildConfig() {
  ...
  return {
    ...
    _comment: [
      'Security headers, SEO-friendly caching, and enumerated SPA',
      'rewrites for Geck Inspect.',
      '',
      'GENERATED by scripts/build-vercel-json.mjs — do not edit by hand.',
      'Update the template inline in that script, or the route manifest',
      'in scripts/seo-routes.mjs, and re-run `pnpm build`.',
      '',
      'Routing model:',
